...
local root_markers = {'gradlew', 'mvnw', '.git', 'build.gradle.kts'}
...
local config = {
    ...
    settings = {
        java = {
            ...
            contentProvider = { preferred = 'vineflower' },  -- Use fernflower to decompile library code
